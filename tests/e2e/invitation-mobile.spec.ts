...
test.describe("Invitation Token Page - Mobile Responsiveness", () => {
	...
	test("should display invitation page correctly on mobile", async ({
		page,
	}) => {
	...
	test("should scroll properly on mobile when content is long", async ({
		page,
	}) => {
		...
		if (bodyHeight > viewportHeight) {
			...
			const footer = page.locator("p", {
				hasText: "participate in the discussion",
			});
